...
const EM_ViewProject = () => {
    ...
    return (
        <div className="card-details-container" style={{padding: "30px"}}>
            <div className="card">
                ...
                <div className="card-footer">
                    <button className="view-button" onClick={handleEditClick}>
                        Edit
                    </button>
                </div>
            </div>
